...
#import "aug15AppDelegate.h"
#import "Model.h"
#import "TableViewController.h"

@implementation aug15AppDelegate
@synthesize window = _window;

- (BOOL) application: (UIApplication *) application didFinishLaunchingWithOptions: (NSDictionary *) launchOptions
{
	//self.window = [[UIWindow alloc] initWithFrame: [UIScreen mainScreen].bounds];
    self.window = [[UIWindow alloc] initWithFrame: CGRectMake(0, 0, 220, 380)];
	...
	TableViewController *tableViewController = [[TableViewController alloc]
                                                initWithStyle: UITableViewStyleGrouped//UITableViewStylePlain
                                                model: model
